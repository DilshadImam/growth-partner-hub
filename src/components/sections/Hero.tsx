...
const stats = [
  ...
  { icon: Sparkles, value: "95%", label: "Client Retention" },
];
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground">Your Digital Growth Partner</span>
          </motion.div>
          ...
          >
            From websites to leads to revenue. We help startups and growing businesses 
            dominate digital platforms and reach customers that matter.
          </motion.p>
